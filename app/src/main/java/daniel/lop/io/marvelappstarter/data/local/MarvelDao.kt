...
// Room - 3º passo: interface responsavel pelo acesso ao BD
@Dao // data access object
interface MarvelDao {

    @Insert(onConflict = OnConflictStrategy.REPLACE) // se houver conflito de id
    suspend fun insert(characterModel: CharacterModel) : Long

    // não precisa ser suspend, Flow já é
